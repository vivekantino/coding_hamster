...
class AppButton extends StatelessWidget {
  ...
  AppButton._({
    ...
    Widget? rightIcon,
    super.key,
  })  : _buttonColor = buttonColor ?? AppColors.primary101.shade4,
        _disabledButtonColor =
            disabledButtonColor ?? AppColors.primary101.shade2,
  ...
  AppButton.primaryMedium({
    ...
    Widget? rightIcon,
          ...
          disabledForegroundColor: AppColors.primary101.shade3,
          disabledButtonColor: AppColors.primary101.shade2,
          elevation: elevation,
  ...
  AppButton.darkButton({
    ...
    Widget? rightIcon,
          ...
          disabledButtonColor: AppColors.primary2.shade5,
  ...
  AppButton.whiteBorderButton({
    ...
    EdgeInsets? padding,
          ...
          disabledForegroundColor: AppColors.white,
          borderSide:
              borderSide ?? BorderSide(color: AppColors.primary1.shade1),
          elevation: elevation,
          leftIcon: leftIcon,
          rightIcon: rightIcon,
        );
